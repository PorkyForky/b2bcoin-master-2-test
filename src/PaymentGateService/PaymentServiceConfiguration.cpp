...
void Configuration::initOptions(boost::program_options::options_description& desc) {
  desc.add_options()
      ...
      ("spend-key,s", po::value<std::string>(), "Generate a wallet container with this secret spend key")
      ("view-key,v", po::value<std::string>(), "Generate a wallet container with this secret view key")
